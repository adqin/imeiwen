...
$offset = ($page - 1) * $limit;
$sql = "select p.`post_id`,p.`title`,p.`author`,p.`image_url`,p.`image_up_time`,p.`description` from `connect_zan` as mix, `post` as p  where $where order by mix.`up_time` desc limit $limit offset $offset";
